package com.uninter.gerenciadorunidade.controller.employee;
...
import com.uninter.gerenciadorunidade.controller.employee.dto.EmployeeResponse;
import com.uninter.gerenciadorunidade.controller.employee.dto.EvaluationResponse;
import com.uninter.gerenciadorunidade.controller.employee.dto.UpdateEmployeeRequest;
import com.uninter.gerenciadorunidade.service.unity.EmployeeService;
...
public class EmployeeController {
    ...
    public ResponseEntity<EmployeeResponse> create(@Valid @RequestBody CreateEmployeeRequest request) {
        return ResponseEntity
            ...
            .body(EmployeeResponse.fromModel(employeeService.create(request)));
    }
    ...
    public ResponseEntity<EmployeeResponse> findById(@PathVariable Long id) {
        return ResponseEntity.ok(EmployeeResponse.fromModel(employeeService.findById(id)));
    }
    ...
    public ResponseEntity<EmployeeResponse> update(@PathVariable Long id,
        ...
        return ResponseEntity.ok(EmployeeResponse.fromModel(employeeService.update(id, request)));
    }
    ...
    public ResponseEntity<EvaluationResponse> addEvaluation(@PathVariable Long id,
        ...
        return ResponseEntity
            .status(HttpStatus.CREATED)
            .body(EvaluationResponse.fromModel(employeeService.addEvaluation(id, request)));
    }
