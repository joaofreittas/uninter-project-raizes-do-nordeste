package com.uninter.gerenciadorunidade.controller.audit;

import com.uninter.gerenciadorunidade.controller.audit.dto.AuditLogResponse;
import com.uninter.gerenciadorunidade.service.audit.AuditLogService;
...
public class AuditLogController {
    ...
    public ResponseEntity<List<AuditLogResponse>> findAll() {
        var logs = auditLogService.findAll().stream()
    ...
    public ResponseEntity<AuditLogResponse> findById(@PathVariable Long id) {
        return ResponseEntity.ok(AuditLogResponse.fromModel(auditLogService.findById(id)));
    }
